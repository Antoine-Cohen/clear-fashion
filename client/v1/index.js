...
// I can find on these e-shop
// 2. Log the variable

const cheapest = 'https://www.loom.fr/collections/tous-les-vetements/products/le-t-shirt';
...
console.log(single_brand_names);
...
for(let i = 0;i<marketplace.length;i++){
  avg_pricetab.push(marketplace[i].price);
  avg_price = avg_price + marketplace[i].price; 
}
avg_price = avg_price/marketplace.length;
// 2. Log the average
...
const Products_by_brands = marketplace.reduce(function (r, a) {
  r[a.brand] = r[a.brand] || [];
  r[a.brand].push(a);
  return r;
}, Object.create(null));
...
//
// 2. Log the variable
console.log(Products_by_brands);
// 3. Log the number of products by brands
for (const [key, value] of Object.entries(Products_by_brands)) {
